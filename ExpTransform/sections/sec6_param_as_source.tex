...
以 Parametric 载体为源端的转化共两条:Evaluator-Driven Optimization 把固化在评估器参数中的判断能力转入 Policy 参数,Parametric Externalization 把 Policy 权重中已内化的决策或评估能力外化为可被其他系统使用的 Tokenized artifacts。
...
\input{sections/Tables/evaluator2policy}
...
\input{sections/Tables/policy2token}
